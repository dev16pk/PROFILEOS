...
const Chat = (() => {
  ...
  const KB = {
    ...
    sap_detail: `Devyani is an SAP CPQ expert (95% proficiency, 5/5 skill) with 8 enterprise engagements:\n\n1. HPI (2024–2025) — Senior Developer — 1.5 years building multi-country pricing engine, ETO product profiling, .NET/REST microservice APIs\n2. IBMHW (2023–2024) — Fullstack Developer — 1 year: 3D/AR product views, WatsonX automation, GraphQL microservices, ML proficiency scoring\n3. FARO (2022) — Developer — 6 months: approval rules, pricing engine, warranty management, dynamic discounting\n4. IBMSW (2021–2023) — Lead Developer — 2.5-year full quote-to-cash: CPI/S4/VCPS integration, CPQ+Commerce, WatsonX chatbot, approval automation\n5. Konica Minolta (2021–2022) — Developer — 9 months: ticketing, dashboards, product automation, S4/HANA + CPI + VCPS integration\n6. Rogers (2021) — Developer — 2 months: CSV product portfolio automation\n7. DTNA (2021) — Developer — 2 months: PriceFx ↔ CPQ integration\n8. Kelloggs (2020) — Developer — Salesforce Commerce storefront\n\nFirm Initiative: SAP CX Campaign-to-Cash (C2C) — Architect — Building agents and skills with SAP Core AI and SAP Joule for CPQ production quote replication, user story development, and integration. 2 phases completed.\n\nAlso proficient in SAP CPI (4/5), S4/HANA (4/5), BTP/Commerce (4/5), SAP AI Core (4/5), SAP Joule (4/5), and Salesforce (3/5).`,

    genai_detail: `Devyani has led 4 major GenAI projects:\n\n1. Symetra 10x (2026, ongoing) — Senior Architect — Agentic AI framework for financial document analysis: PII redaction, validation, suitability checks, risk evaluation, and automated report generation with human-in-the-loop accept/reject\n2. PMI SMT (2026, complete) — Fullstack Developer — Gemini-powered executive mentorship app with voice sensitivity and user profiling\n3. AI Advantage (2025–2026, complete) — AI Architect & Agent Developer — Contract data extraction with AWS Strand Agents, RAG/MCP, LangChain/LangGraph. Sold to Disney, ESPN, BioMarin, and FedEx\n4. SANOFI (2025, complete) — Lead Developer — Full automation pipeline for client delivery (requirements → pre-prod → go-live), converted to Deloitte internal accelerator\n\nAI skill ratings: LangChain/LangGraph (5/5), RAG/AWS Bedrock (5/5), LLMs/GPT-4/Gemini/Watson (4/5), Agentic AI/MCP (4/5), Model Finetuning (4/5), NLP/Voice AI (3/5), TensorFlow/Keras (3/5).`,

    impact_detail: `Impact and social projects (6 total):\n\n1. AR Pipeline (2026, ongoing) — Co-Founder & Lead Developer — Centralized AR asset pipeline and marketplace: AR battle arenas with robot wars (launched at college fest), 3D asset rendering, and hardware blueprint generation from AR models. Collaboration with mechatronics engineers.\n2. AM&C Community Apps (2025–2026, ongoing) — Fullstack Developer — End-to-end dashboards, 2D games (Android/iOS), AR/VR apps for Gurgaon AM&C events\n3. Explainosphere (2024, complete) — Fullstack Developer — Universal curiosity learning platform built with FastAPI, Next.js, GPT-4, PostgreSQL, Redis\n4. AMAN Security Device (2023–2025, complete) — Creator & Lead Engineer — Crowd-scanning for concealed weapons with threat-level calculation, tested with BSF battalion 98, built in response to the 2023 Nuh Haryana attacks\n5. E-MedicalHELP (2023, complete) — Lead Developer & Data Analyst — Centralized emergency medical system with NLP voice processing, IoT device integrations, hospital alignment\n6. Navgyan Niyojan (2020–2026, ongoing) — Volunteer Developer — Education curriculum improvement initiative through NGO collaboration`,
    ...
    dsa_ml: `DSA & ML skill branch:\n• Data Structures & Algorithms — 4/5\n• Dynamic Programming — 4/5\n• Genetic Algorithms — 4/5\n• Knowledge Ontology — 4/5\n• Cognitive Computing — 3/5\n• ML Pipelines — 4/5\n• Evolutionary Algorithms — 3/5\n\nApplied in projects like MCOACH (ontology + Keras), CUBE DEALT (TensorFlow + evolutionary algorithms), IBMHW (ML proficiency scoring), AI Advantage (RAG pipelines), and Symetra 10x (agentic document analysis).`,

    ar_pipeline: `AR Pipeline (2026, ongoing) — Co-Founder & Lead Developer\n\nA centralized AR asset pipeline and marketplace, co-founded by Devyani with friends from mechatronics engineering. The idea was born from the high cost of robotics hardware making it inaccessible to most people.\n\nThe team started by exploring how to transform physical robot battles into virtual AR experiences. After initial R&D and polling that showed strong interest, they built AR battle arenas with robots and weaponry and launched it as an event at a college fest — a successful debut.\n\nNow building:\n1. AR Asset Pipeline — Centralized pipeline for AR frameworks (like Pinterest for AR assets) with easy rendering\n2. AR Marketplace — A marketplace for 3D assets including home decor, accessories, and robotics components\n3. Robot Battle Wars — Extended AR battle arena concept with full robot and weaponry systems\n4. Hardware Blueprint Generation — Leveraging the AR framework to generate actual hardware blueprints for robots, weapons, and war equipment\n\nTech: AR/VR, 3D Assets, Marketplace, Robotics, Blueprint Generation.\nRole: Co-Founder & Lead Developer.`
  };
  ...
  const intents = [
    ...
    { patterns: [/experience|years|how long/i],
      reply: () => `Devyani has ${KB.experience}. ${KB.promotions}. She has delivered 16+ projects spanning SAP Products (8), GenAI (4), Impact (6), and College (3).` },

    { patterns: [/promot/i],
      reply: () => `${KB.promotions}. She joined Deloitte in Sept 2020 as an Analyst, was promoted to Consultant/Developer in 2022 based on her SAP CPQ delivery, and to Senior Consultant/Senior Developer & Solutions Architect in 2025 after leading GenAI and enterprise projects.` },
    ...
    { patterns: [/company|deloitte|where.*(work|employ)/i],
      reply: () => `Devyani works at ${KB.company}. ${KB.promotions}. She's recognized as a SAP Solutions SME, AI Architect, and Solutions Architect within the organization. She's also an integral part of the Gurgaon AM&C community.` },
    ...
    { patterns: [/c2c|campaign.?to.?cash|sap.?cx|sap.?joule|sap.?core.?ai|sap.?ai.?core|quote.?replication/i],
      reply: () => `SAP CX Campaign-to-Cash (C2C) Initiative \u2014 Architect\n\nThis is a Deloitte firm-wide initiative (not a client project) within the SAP CX practice. Devyani is one of the architects building agents and skills using SAP Core AI and SAP Joule for:\n\n1. Production Quote Replication \u2014 AI-driven replication and validation of CPQ production quotes\n2. User Story Development \u2014 Automated generation and refinement of user stories for CPQ implementations\n3. Integration \u2014 Connecting SAP AI agents across the Campaign-to-Cash landscape\n\n2 phases have been completed. This initiative combines her deep SAP CPQ expertise with her AI architecture skills.\n\nSAP AI Core: 4/5 | SAP Joule: 4/5` },
    ...
    { patterns: [/symetra|10x|pii redact|suitability|risk evaluat.*finance|financial.*document/i],
      reply: () => `Symetra 10x (2026, ongoing) — Senior Architect\n\nAgentic AI framework for financial document analysis at enterprise scale. The multi-agent pipeline handles:\n1. PII Redaction — automated detection and redaction of personally identifiable information\n2. Validation — document integrity and completeness checks\n3. Suitability Checks — evaluating financial applications against compliance criteria\n4. Risk Evaluation — AI-driven risk scoring and assessment\n5. Report Generation — automated issue reports with accept/reject recommendations\n\nThe system is human-in-the-loop: agents generate recommendations but the final accept/reject decision rests with the user.\n\nTech: Agentic AI, Finance, PII Redaction, Risk Evaluation, Document Analysis.` },

    { patterns: [/ar.?pipeline|ar.?asset|ar.?marketplace|robo.?battle|battle.?arena|iron.?man.*(concept|project)|blueprint.?generat/i],
      reply: () => KB.ar_pipeline },
    ...
    { patterns: [/project|portfolio|what.*(built|made|created|done|delivered)/i],
      reply: () => `Devyani has delivered 16+ projects across 4 categories:\n\n📋 SAP Products (8): HPI, IBMHW, FARO, IBMSW, Konica Minolta, Rogers, DTNA, Kelloggs\n🤖 GenAI (4): Symetra 10x, PMI SMT, AI Advantage (Disney/ESPN/BioMarin/FedEx), SANOFI\n💛 Impact (6): AR Pipeline, AM&C Community Apps, Explainosphere, AMAN Security Device, E-MedicalHELP, Navgyan Niyojan\n🎓 College (3): CUBE DEALT, MCOACH, CRASH SAVERS\n\nAsk about any specific project for details!` },
  ...
  const keywordMap = {
    ...
    'tool': KB.inventory,
    'project': `Devyani has delivered 16+ projects across SAP Products (8), GenAI (4), Impact (6), and College (3).`,
    ...
    'deloitte': `Devyani is a Senior Developer & Solutions Architect at Deloitte with 5.8 years of experience. ${KB.promotions}. Recognized as SAP Solutions SME, AI Architect, and Solutions Architect.`,
